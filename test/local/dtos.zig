...
pub const Booking = struct {
    ...
    roomType: RoomType,
    roomNumber: i32,
    bookingStartDate: []const u8,
    bookingEndDate: ?[]const u8,
    cost: f64,
...
pub const BackgroundJobRef = struct {
    id: i64,
    refId: []const u8,
};
...
pub const QueueCheckUrlsResponse = struct {
...
pub const AdminDataResponse = struct {
    pageStats: []PageStats,
};
...
pub const QueueCheckUrls = struct {
    urls: []const u8,
};
