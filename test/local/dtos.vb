...
Namespace Global
    ...
    Namespace MyApp.ServiceInterface
        ...
        Public Partial Class QueueCheckUrls
            Implements IReturn(Of QueueCheckUrlsResponse)
            Public Overridable Property Urls As String
        End Class

        Public Partial Class QueueCheckUrlsResponse
            Public Overridable Property JobRef As BackgroundJobRef
        End Class
    End Namespace
