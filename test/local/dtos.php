...
class BackgroundJobRef implements JsonSerializable
{
    public function __construct(
        /** @var int */
        public int $id=0,
...
class QueueCheckUrlsResponse implements JsonSerializable
{
    public function __construct(
        /** @var BackgroundJobRef|null */
    ...
    /** @throws Exception */
    public function fromMap($o): void {
        if (isset($o['jobRef'])) $this->jobRef = JsonConverters::from('BackgroundJobRef', $o['jobRef']);
    }
    ...
    {
        $o = [];
        if (isset($this->jobRef)) $o['jobRef'] = JsonConverters::to('BackgroundJobRef', $this->jobRef);
        return empty($o) ? new class(){} : $o;
    }
}
...
#[Returns('QueueCheckUrlsResponse')]
class QueueCheckUrls implements IReturn, JsonSerializable
{
    public function __construct(
        /** @var string */
        public string $urls=''
    ...
    /** @throws Exception */
    public function fromMap($o): void {
        if (isset($o['urls'])) $this->urls = $o['urls'];
    }
    ...
    {
        $o = [];
        if (isset($this->urls)) $o['urls'] = $this->urls;
        return empty($o) ? new class(){} : $o;
    }
    public function getTypeName(): string { return 'QueueCheckUrls'; }
    public function getMethod(): string { return 'POST'; }
    public function createResponse(): mixed { return new QueueCheckUrlsResponse(); }
}
