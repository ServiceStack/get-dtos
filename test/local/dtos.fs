...
open ServiceStack.DataAnnotations
    ...
    [<AllowNullLiteral>]
    type QueueCheckUrlsResponse() = 
        member val JobRef:BackgroundJobRef = null with get,set
    ...
    [<AllowNullLiteral>]
    type QueueCheckUrls() = 
        interface IReturn<QueueCheckUrlsResponse>
        member val Urls:String = null with get,set
