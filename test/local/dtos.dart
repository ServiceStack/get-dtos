...
class BackgroundJobRef implements IConvertible
{
    int? id;
    String? refId;

    BackgroundJobRef({this.id,this.refId});
    BackgroundJobRef.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class QueueCheckUrlsResponse implements IConvertible
{
    BackgroundJobRef? jobRef;

    QueueCheckUrlsResponse({this.jobRef});
    QueueCheckUrlsResponse.fromJson(Map<String, dynamic> json) { fromMap(json); }

    fromMap(Map<String, dynamic> json) {
        jobRef = JsonConverters.fromJson(json['jobRef'],'BackgroundJobRef',context!);
        return this;
    }

    Map<String, dynamic> toJson() => {
        'jobRef': JsonConverters.toJson(jobRef,'BackgroundJobRef',context!)
    };

    getTypeName() => "QueueCheckUrlsResponse";
    TypeContext? context = _ctx;
}
...
class QueueCheckUrls implements IReturn<QueueCheckUrlsResponse>, IConvertible, IPost
{
    String? urls;

    QueueCheckUrls({this.urls});
    QueueCheckUrls.fromJson(Map<String, dynamic> json) { fromMap(json); }
    ...
    createResponse() => QueueCheckUrlsResponse();
    getResponseTypeName() => "QueueCheckUrlsResponse";
    getTypeName() => "QueueCheckUrls";
    TypeContext? context = _ctx;
}
...
TypeContext _ctx = TypeContext(library: 'localhost', types: <String, TypeInfo> {
    ...
    'BackgroundJobRef': TypeInfo(TypeOf.Class, create:() => BackgroundJobRef()),
    ...
    'QueueCheckUrlsResponse': TypeInfo(TypeOf.Class, create:() => QueueCheckUrlsResponse()),
    ...
    'QueueCheckUrls': TypeInfo(TypeOf.Class, create:() => QueueCheckUrls()),
