...
open class QueueCheckUrls : IReturn<QueueCheckUrlsResponse>
{
    open var urls:String? = null
    companion object { private val responseType = QueueCheckUrlsResponse::class.java }
    override fun getResponseType(): Any? = QueueCheckUrls.responseType
}
...
open class QueueCheckUrlsResponse
{
    open var jobRef:BackgroundJobRef? = null
}
